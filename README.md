...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y7h0smy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y7h0smy.containers.anotherwebservice.com/
...
```
git clone git@github.com:sulahtla/container-y7h0smy.git
cd container-y7h0smy
```
...
```
docker attach container-y7h0smy
```
